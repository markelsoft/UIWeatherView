...
- (void)currentAddressChanged:(CLLocation *)currentLocation currentAddress:(NSString *)currentAddress oldAddress:(NSString *)oldAddress cityState:(NSString *)cityState;
@end
