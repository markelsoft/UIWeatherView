...
- (void)locationManager:(CLLocationManager *)manager didUpdateHeading:(CLHeading *)heading {
    ...
    if (verbose)
        NSLog(@"[LocationUtils] currentHeading %@", currentHeading);
}
...
- (void)reverseCLGeocoder:(CLGeocoder *)geocoder didFindPlacemark:(CLPlacemark *)placemark {
    ...
    @try {
        ...
        NSString * addressCityState = [self getCityStateAddressForPlacemark:placemark];
            ...
            if (currentAddress != nil) {
                ...
                if (delegate != nil) {
                    ...
                    if (delegate != nil) {
                        ...
                        [delegate currentAddressChanged:currentLocation currentAddress:[currentAddress copy] oldAddress:oldAddress cityState:[addressCityState copy]];
                    }
                }
            }
        }
...
- (NSString *)getCityStateAddressForPlacemark:(CLPlacemark *)placemark {
    NSString * address = nil;
